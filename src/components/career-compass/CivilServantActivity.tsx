...
import { ArrowLeft, Check, Lightbulb, Shield } from "lucide-react";
...
type Stage = "roadmap" | "myth-busting" | "reflection" | "results";
...
export default function CivilServantActivity({ onBack }: CivilServantActivityProps) {
    ...
    const [stage, setStage] = useState<Stage>("roadmap");
