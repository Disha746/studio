...
const feedbackDatabase: Record<string, string> = {
    // Q1
    'Solving it with logic and coding.': "Choosing 'Solving it with logic and coding' shows you enjoy structured problem-solving and systematic thinking. This reveals strong analytical and technical abilities, with a preference for precision and logical reasoning. Such skills are especially valuable in areas where structure and innovation meet. Careers this connects to include Software Developer, Product Manager, and Law.",
    'Looking at data and patterns.': "Selecting 'Looking at data and patterns' indicates you are analytical and detail-focused. This strength in spotting trends is crucial for careers in finance, governance, and strategy. Careers this aligns with include Chartered Accountant, Civil Servant, and Product Manager.",
    ...
    // Q4
    'I love creating and working within logical frameworks and abstract systems.': "A love for 'creating and working within logical frameworks' indicates a strength in abstract and systematic thinking. This is foundational for careers that require building or interpreting complex systems, such as Software Developer and Lawyer.",
    'I grasp abstract concepts best when they are tied to real-world examples and applications.': "Grasping concepts through 'real-world examples' shows you are an applied and practical thinker. This is a valuable trait for careers where theoretical knowledge must be translated into tangible outcomes, like in teaching or design.",
    'I prefer concrete, hands-on tasks and find purely abstract thinking less engaging.': "A preference for 'concrete, hands-on tasks' highlights a practical, tangible approach to work. This is well-suited for careers where the output is a physical or directly observable result, such as Interior Designer or Athlete.",
    'I excel when working with well-defined rule-based systems like tax laws or medication protocols.': "Excelling in 'well-defined rule-based systems' points to a high degree of precision and comfort with compliance. This is essential for professions governed by strict standards, such as Chartered Accountant, Pharmacist, and Law.",
    // Q5
    'Processes are constantly evolving and being redefined.': "Thriving where 'processes are constantly evolving' shows you are adaptable and innovative. This mindset is crucial in dynamic fields like technology and media, fitting roles like Software Developer and Product Manager.",
    'There is a clear structure, established protocols, and predictable workflow.': "A preference for 'clear structure and established protocols' indicates a strength in process-oriented and stable environments. This is a key trait for professions that rely on accuracy and established procedures, such as Chartered Accountant or Pharmacist.",
    'Collaboration and cross-functional teamwork are the primary focus.': "A preference for 'collaboration and teamwork' highlights strong interpersonal and communication skills. This is essential for roles that require coordinating with diverse teams, such as Teacher, Product Manager, or Interior Designer.",
    ...
    // Q7
    'I thrive under pressure and make clear, decisive decisions.': "Thriving 'under pressure' demonstrates resilience and decisive action-making capabilities. This is a critical trait for high-stakes professions such as Doctor, Lawyer, or professional Athlete.",
    // Q8
    'I meticulously double-check my work and follow a strict verification process.': "Meticulously 'double-checking your work' reveals a high attention to detail and a commitment to accuracy. This is a non-negotiable skill in fields where errors have significant consequences, such as in finance or healthcare."
};
