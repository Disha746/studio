...
export default function OccupationDetailsStep({
  ...
  if (IntroComponent) {
    const hasActivity = ['interiordesigner', 'doctor', 'contentcreator', 'graphicdesigner', 'athlete', 'civilservant', 'productmanager', 'charteredaccountant', 'mediaandmasscommunication', 'lawyer', 'pharmacist'].includes(activityName);
